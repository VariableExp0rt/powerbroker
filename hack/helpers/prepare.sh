...
sed -i.bak "s/powerbroker/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/powerbroker" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/powerbroker-controller" "cluster/images/provider-${ProviderNameLower}-controller"
